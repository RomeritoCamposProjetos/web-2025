...
- `{% extends "base.html" %}` → diz que este arquivo **herda** de `base.html`
...
- `{% include 'arquivo.html' %}` é uma **forma de importar um trecho de HTML** de outro arquivo **dentro de um template maior**.
